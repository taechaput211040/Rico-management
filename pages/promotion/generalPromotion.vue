  ...
  <v-flex>
    ...
    <v-container>
      ...
      <v-dialog v-model="addPromotion" max-width="1000px">
        <v-card class="pa-5"
          ><add-promotion @close-dialog="addPromotion = false" :closeDialogMethod="closeDialog"
            @data-sent="data = $event" ></add-promotion
          ><v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="primary" class="btn_sty" @click="closeDialog">บันทึก</v-btn>
        ...
        <v-card class="pa-5">
          ...
          <div>
            ...
            <v-row class="pa-3">
              ...
              <div>
                <!-- expand -->
                <v-expansion-panels accordion style="width: 100%" multiple>
...
export default {
  ...
  methods: {
    ...
    ...mapActions("promotion", ["getPromotion", "updatedPromotion",'deletedPromotion']),
    deletePromotion(id) {
      Swal.fire({
