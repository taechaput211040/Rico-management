      ...
      <v-col cols="12" md="12" lg="4">
        <v-card width="100%" class="elevation-3 rounded-lg pa-2">
          ...
          <v-card-title primary-title class="font-weight-bold error--text">
           ...
           <!-- mobile -->
          <table class="v-data-table d-md-none d-lg-none" v-for="(item, index) in wdlist"  :key="'0_'+index" style="width:100% ;">
          ...
          <table class="d-none d-md-block">
            ...
            <tr v-for="(item, index) in wdlist"  :key="'0_'+index" 
            >
              <td> 
                <div class="text-center my-3 my-md-2 showdetail">
                <div class="font-weight-bold">
      ...
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn color="success" small @click="manualWd_confirm()">
            ยืนยัน</v-btn
          >
          <v-btn color="success" small @click="dialogManualWD = false"
            >ยกเลิก</v-btn
          >
        </v-card-actions>
      </v-card>
